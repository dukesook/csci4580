...
# Function Call
	...
	sw $a0, 220($sp)		# Push argument onto stack
	lw $a0, 220($sp)		# Load argument into $a register
...
# Function Call
	...
	move $a0, $sp		# VAR local make a copy of stackpointer
	addi $a0, $a0, 20		# EMIT Var local variable
	add $a0, $a0, $a1		# Compute address of array element
	lw $a0, ($a0)		# # load variable value
	sw $a0, 224($sp)		# Push argument onto stack
	lw $a0, 224($sp)		# Load argument into $a register
	move $t0, $a0		# Move argument into temp variable
	jal foo		# Function call jump and link
# Function Call
	move $a0, $sp		# VAR local make a copy of stackpointer
	...
	lw $a0, ($a0)		# # load variable value
	sw $a0, 228($sp)		# Push argument onto stack
	lw $a0, 228($sp)		# Load argument into $a register
	move $t0, $a0		# Move argument into temp variable
	jal foo		# Function call jump and link
# Function Call
	...
	add $a0, $a0, $a1		# Compute address of array element
	lw $a0, ($a0)		# # load variable value
	sw $a0, 232($sp)		# Push argument onto stack
	lw $a0, 232($sp)		# Load argument into $a register
	move $t0, $a0		# Move argument into temp variable
	jal foo		# Function call jump and link
# Function Call
	la $a0, y		# EMIT Var global variable
	lw $a0, ($a0)		# # load variable value
	sw $a0, 236($sp)		# Push argument onto stack
	lw $a0, 236($sp)		# Load argument into $a register
	move $t0, $a0		# Move argument into temp variable
	jal foo		# Function call jump and link
# Function Call
	...
	add $a0, $a0, $a1		# Compute address of array element
	lw $a0, ($a0)		# # load variable value
	sw $a0, 240($sp)		# Push argument onto stack
	lw $a0, 240($sp)		# Load argument into $a register
	move $t0, $a0		# Move argument into temp variable
	jal foo		# Function call jump and link
